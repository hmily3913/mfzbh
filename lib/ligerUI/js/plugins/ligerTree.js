...
(function ($)
{
    ...
    $.ligerui.controls.Tree.ligerExtend($.ligerui.core.UIComponent, {
        ...
        //parm treeNode dom节点li、节点数据 或者节点 dataindex
        getNodeDom: function (nodeParm)
        {
            ...
            else if (typeof (nodeParm) == "object" && 'target' in nodeParm) //nodedata
            {
                return g.getNodeDom(nodeParm['target']);
            }
            return nodeParm;
        },
        //parm treeNode dom节点li、节点数据 或者节点 dataindex
