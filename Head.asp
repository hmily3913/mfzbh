...
'========
%>
<table name="Trans" id="Trans" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:宋体;font-size:12px;color: #FFF;background-color:#1D3F7F;">
  <tr>
    <td width="200" nowrap style="BORDER-BOTTOM: #77ABF2 1px solid;" >版本号：<%= WebRevision %>[<%= WebDate %>]</td>
    <td width="100" nowrap style="BORDER-BOTTOM: #77ABF2 1px solid;"><%=session("UserName")%>：[<%=session("UserID")%>]</td>
  </tr>
  <tr>
    <td nowrap id="DateTime" colspan="2">
      <script> 
//--------------------农历算法----------------------------------------
